...
import edu.arizona.biosemantics.matrixgeneration.annotationSchema.jaxb.Character;
...
//	protected HashMap sigPluMap;  //by Jing Liu Oct. 31, 2013
	...
	private void normalizeCharacterNames(List<edu.arizona.biosemantics.matrixgeneration.annotationSchema.jaxb.Character> chars) {
		...
		/*	String singular=(String)sigPluMap.get(normalized);    //by Jing Liu   Oct.31, 2013
			if (singular!=null)
				normalized = singular;*/
