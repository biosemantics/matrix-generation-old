...
import edu.arizona.biosemantics.matrixgeneration.conversion.datapassing.TaxonCharacterStructureTriple;
import edu.arizona.biosemantics.matrixgeneration.sdd.AbstractCharacterDefinition;
import edu.arizona.biosemantics.matrixgeneration.sdd.AbstractRef;
...
import edu.arizona.biosemantics.matrixgeneration.sdd.CharacterSet;
import edu.arizona.biosemantics.matrixgeneration.sdd.CharacterStateSeq;
import edu.arizona.biosemantics.matrixgeneration.sdd.ConceptStateDef;
import edu.arizona.biosemantics.matrixgeneration.sdd.ConceptStateRef;
...
import edu.arizona.biosemantics.matrixgeneration.sdd.QuantitativeCharMapping;
import edu.arizona.biosemantics.matrixgeneration.sdd.QuantitativeCharMappingSet;
...
import edu.arizona.biosemantics.matrixgeneration.sdd.ValueRangeWithClass;
import edu.arizona.biosemantics.matrixgeneration.states.IState;
import edu.arizona.biosemantics.matrixgeneration.states.RangeState;
import edu.arizona.biosemantics.matrixgeneration.states.SingletonState;
...
import edu.arizona.biosemantics.matrixgeneration.util.QuantitativeStateDef;
import edu.arizona.biosemantics.matrixgeneration.util.TypeUtil;
...
public class CharacterSetHandler extends Observable implements Handler,
				...
				for(IState state : stateList) {		
					if(state instanceof SingletonState) {
						...
						if(state.getMap().get(RangeState.KEY_FROM) instanceof String) {
							...
							((edu.arizona.biosemantics.matrixgeneration.sdd.CategoricalCharacter)character).setStates(
	...
	private void putMappingAndRangeOnQuantitativeCharacter(
		...
		if (state instanceof SingletonState) {
			...
			((edu.arizona.biosemantics.matrixgeneration.sdd.QuantitativeCharacter) character).setMappings(mappingSet);
			((edu.arizona.biosemantics.matrixgeneration.sdd.QuantitativeCharacter) character)
	 ...
	 * SDD Dataset.
	 * @see edu.arizona.biosemantics.matrixgeneration.conversion.Handler#handle()
	 */
	@Override
	public void handle() {
