...
import edu.arizona.biosemantics.matrixgeneration.sdd.ModifierSeq;
...
public class ModifierHandler extends Observable implements Handler, Observer {
	...
	private static edu.arizona.biosemantics.matrixgeneration.sdd.ObjectFactory sddFactory = new edu.arizona.biosemantics.matrixgeneration.sdd.ObjectFactory();
