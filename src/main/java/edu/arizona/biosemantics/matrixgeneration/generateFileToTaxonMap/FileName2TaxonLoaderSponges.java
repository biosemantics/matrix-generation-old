...
public class FileName2TaxonLoaderSponges extends FileName2TaxonLoader  {
	 ...
	 * 
	 */
	public FileName2TaxonLoaderSponges(String inputfilepath)  throws Exception {
		super(inputfilepath);
	}
...
/*	public static void main(String[] args) {
		...
		FileName2TaxonLoaderSponges fnts = new FileName2TaxonLoaderSponges(filepath);
